...
import product_big_img_01 from '../assets/images/product_big_img_01.jpg'
              ...
              <div class="row">
                <div class="col">
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      <li class="breadcrumb-item"><Link href="#">Primary school </Link></li>
                      <li class="breadcrumb-item"><Link href="#">Shop </Link></li>
                    ...
                    <div class="col-sm-3">
                      <div class="productGallery">
                        <div class="singleItem bgGray p-2 mb-2">
                          <img src={product_big_img_01} alt=""/>
                        </div>
                ...
                <div class="col-sm-6">
                  <div class="card productCardDetails border-0">
                    <div class="card-header border-0 bg-white">
                      ...
                      <h6 class="authName">by <Link href="#">Sam Smith</Link></h6>
                    </div>
                    ...
                    <div class="card-body productCardBody">
                      ...
                      <div class="productBtnGroup mt-4 clearfix">
                        <div class="row no-gutters">
                          <div class="col-sm-2">
                            <input class="form-control inputValue" type="number"/>
                          </div>
  
                          <div class="col text-center">
                            <Link href="#"  class="btn linkBtn" data-target="#productCartModal" data-toggle="modal"><i class="fas fa-shopping-cart"></i> Add to cart</Link>
                          </div>
  
                          <div class="col text-center">
                            <Link href="#" class="btn linkBtnBorder"><i class="far fa-star"></i> Add to favorites</Link>
                          </div>
                        </div>
                      ...
                      <div class="productDetailsNavTabs mt-3 clearfix">
                        <ul class="nav nav-pills productNavTabs mb-3" id="pills-tab" role="tablist">
                          <li class="nav-item">
                            <Link class="nav-link active" id="pills-description-tab" data-toggle="pill" href="#pills-description" role="tab" aria-controls="pills-description" aria-selected="true">Description</Link>
                          </li>
                          <li class="nav-item">
                            <Link class="nav-link" id="pills-specifications-tab" data-toggle="pill" href="#pills-specifications" role="tab" aria-controls="pills-specifications" aria-selected="false">Specifications</Link>
                          </li>
                          <li class="nav-item">
                            <Link class="nav-link" id="pills-reviews-tab" data-toggle="pill" href="#pills-reviews" role="tab" aria-controls="pills-reviews" aria-selected="false">Reviews (7)</Link>
                          </li>
                        </ul>
